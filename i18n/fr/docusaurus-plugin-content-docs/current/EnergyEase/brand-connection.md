...
1. Ouvrez l’application Energy Ease et accédez à la page **Profil**.
...
👉 Pour des instructions d’autorisation détaillées :
...
Ajoutez la prise intelligente ou le compteur d’énergie dans l’application Energy Ease et assurez-vous que l’appareil est en ligne.
...
👉 Pour plus de détails, veuillez consulter : [Source de données](./profile.md#5-source-de-données)
