...
## 11. À propos de Energy Ease

Touchez **À propos de Energy Ease** pour en savoir plus sur l’application : version actuelle, accords de service et confidentialité, liste de partage d’informations à des tiers, description des autorisations et gestion des permissions système.

<img src={require("./img/about_energy_ease.png").default} width="240"/>
