...
1. Öffnen Sie die Energy Ease App und gehen Sie zu **Profil**.
...
👉 Detaillierte Anweisungen zur Autorisierung:
...
Fügen Sie in der Energy Ease App die intelligente Steckdose oder den Energiezähler hinzu und stellen Sie sicher, dass das Gerät online ist.
...
👉 Detaillierte Anleitung: [Datenquellen](./profile.md#5-datenquelle)
