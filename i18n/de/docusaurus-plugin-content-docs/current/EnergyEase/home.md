...
| --- | --------------- | --- |
| 1   | My Zuhause      | Zeigt den aktuellen Namen des Zuhauses an. Tippen Sie darauf, um alle unter Ihrem Konto gespeicherten Zuhause anzuzeigen, zu wechseln oder zu verwalten. |
...
<img src={require("./img/dashboard.jpg").default} width="240"/>
...
<img src={require("./img/power_flow.jpg").default} width="240"/>
