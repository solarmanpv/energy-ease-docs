...
<Tabs>
  ...
  :::info
  当前蓝牙发现功能适用于SOLARMAN、INDEVOLT、IZYPOWER设备。点击App内的**查看支持蓝牙发现的设备列表**可获取详情。
  :::

  1. 请确保手机蓝牙已开启。如处于关闭状态，App会弹出提示框请求开启。
  2. App将自动扫描并列出周边可用的蓝牙设备，根据产品名称与序列号选择您的目标设备进行连接。
