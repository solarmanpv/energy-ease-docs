...
👉 更多并机配置与操作说明，请参阅 [并机说明](https://docs.indevolt.com/docs/hardware/technical-note/cluster)
...
点击**关于Energy Ease**，了解关于App应用的相关信息，包含当前版本、服务及隐私协议、第三方信息共享清单、应用权限说明、系统权限管理等信息。
