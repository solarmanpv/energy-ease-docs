...
const config: Config = {
  title: "Energy Ease Docs",
  tagline:
    "Explore comprehensive documentation for Energy Ease App.",
  ...
  url: "https://docs-energy-ease.netlify.app",
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/solarmanpv/energy-ease-docs/tree/main",
        },
        blog: {
