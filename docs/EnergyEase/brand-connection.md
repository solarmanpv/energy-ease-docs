...
1. Open the Energy Ease App and go to the **Profile** page.
...
👉 For detailed authorization instructions, see:
...
Add the smart plug or smart meter in the Energy Ease App and ensure the device is online.
...
👉 For detailed instructions, please refer to: [Data Source](./profile.md#5-data-source)
